...
const MoveDetailSpecific = (props) => {
    let data = props.moveData
    let typeColor = data.type.name
                ...
                <View style={styles.containerRow}>
                    <View style={styles.containerInnerRow}>
                        <View style={styles.containerTitleHabitat}>
                            <Text style={{color: rgbColor}}>Base Power</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.containerInnerRow}>
                        <View style={styles.containerTitleHabitat}>
                            <Text style={{color: rgbColor}}>Accuracy</Text>
                        </View>
                    </View>
                    <View style={styles.containerDividerRow}>
                        <View style={styles.dividerStyle}></View>
                    ...
                    <View style={styles.containerInnerRow}>
                        <View style={styles.containerTitleHabitat}>
                            <Text style={{color: rgbColor}}>PP</Text>
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.containerRowContent}>
                <View style={styles.containerInnerRow}>
                    <View style={styles.containerItemsHabitat}>
                        <Text style={styles.textStatsStyle}>{data.power ? data.power : 0}</Text>
                    </View>
                </View>
                <View style={styles.containerDividerRow}>
                    <View style={styles.dividerStyle}></View>
                ...
                <View style={styles.containerInnerRow}>
                    <View style={styles.containerItemsHabitat}>
                        <Text style={styles.textStatsStyle}>{data.accuracy} %</Text>
                    </View>
                </View>
                <View style={styles.containerDividerRow}>
                    <View style={styles.dividerStyle}></View>
                ...
                <View style={styles.containerInnerRow}>
                    <View style={styles.containerItemsHabitat}>
                        <Text style={styles.textStatsStyle}>{data.pp}</Text>
                    </View>
                </View>
            </View>
        )
...
export default MoveDetailSpecific;